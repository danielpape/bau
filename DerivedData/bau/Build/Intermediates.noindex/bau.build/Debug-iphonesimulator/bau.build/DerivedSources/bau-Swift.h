...
SWIFT_MODULE_NAMESPACE_PUSH("bau")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC3bau11AppDelegate")
...
SWIFT_CLASS("_TtC3bau9GameScene")
...
@property (nonatomic, readonly, strong) SKNode * _Nonnull shapesLayer;
@property (nonatomic, readonly, strong) SKNode * _Nonnull tilesLayer;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
- (void)addTiles;
- (CGPoint)pointForColumn:(NSInteger)column row:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)trySwapWithHorizontal:(NSInteger)horzDelta vertical:(NSInteger)vertDelta;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified nextPuzzleButton;
